...
public class Utilities {
    ...
    public static final String PREFIX = ChatColor.AQUA + "StackMob " + ChatColor.GRAY + ">> " + ChatColor.RESET;
    ...
    public static String translateColorCodes(String toTranslate) {
        ...
        while (matcher.find()) {
            //ChatColor chatColor = ChatColor.getByChar(matcher.group().substring(1,8));
