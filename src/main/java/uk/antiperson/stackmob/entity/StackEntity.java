...
public class StackEntity implements Serializable {
    ...
    public void setSize(int newSize, boolean update) {
        ...
        entity.setMetadata(sm.getStackKey(), new StackMetadata(sm, newSize));
        stackSize = newSize;
        if (update) {
            getTag().update();
        }
    ...
    private LivingEntity spawnClone() {
        ...
        /*if (Utilities.isPaper()) {
            return (LivingEntity) getWorld().spawnEntity(getEntity().getLocation(), getEntity().getType(), getEntity().getSpawnReason());
        }*/
